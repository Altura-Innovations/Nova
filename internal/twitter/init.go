...
import (
	...
	twitter_manager "github.com/Neura-AI-Labs/nova/managers/twitter"
...
func (k *Twitter) create() error {
	...
	assistantName := "nova"
	assistantID := id.FromString("nova")
	...
	personalityManager, err := personality.NewPersonalityManager(
		...
		personality.WithPersonality(&personality.Personality{
			Name:        assistantName,
			Description: "nova is a 35 year old software architect who has become disillusioned with modern tech trends. Despite being highly skilled, they're known for their dry humor and skepticism towards buzzwords and hype-driven development.",
